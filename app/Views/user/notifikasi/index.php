...
<div class="card mb-4 border-0 shadow-sm">
    <div class="card-body p-3" style="background:linear-gradient(135deg,#1a237e,#00897b);">
        <div class="d-flex justify-content-between align-items-center text-white">
            <div>
                <h4 class="mb-0 fw-bold"><i class="bi bi-bell-fill me-2"></i>Notifikasi Saya</h4>
            ...
            <?php if ($unread_count > 0): ?>
            <form action="/user/notifikasi/baca-semua" method="post" style="display:inline;">
                <?= csrf_field() ?>
    ...
    <div class="card-body p-0">
        <?php if (!empty($notifikasi)): ?>
            <?php foreach ($notifikasi as $n): ?>
                ...
                $linkTarget = '/user/notifikasi/baca/' . $n['id_notifikasi'];
        ...
        <?php else: ?>
            <div class="text-center py-5 text-muted">
                ...
                <p class="mb-0">Notifikasi tagihan, keluhan, pengumuman, dan kontrak akan muncul di sini.</p>
            </div>
        <?php endif; ?>
    </div>
</div>
